...
- **Say what the reader can’t already see.** Restating the code, the diff, or the obvious earns nothing — spend words on intent, constraints, gotchas, tradeoffs; cut what echoes.
