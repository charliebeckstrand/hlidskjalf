---
name: cadence
description: Match code to the conventions a codebase already follows. Use when adding a file, module, or feature — or when asked if code fits the surrounding style.
---
